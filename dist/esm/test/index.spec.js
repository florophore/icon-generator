...
import ofs from 'fs';
const images = {
    "2fef7c3fc7e55034b2c382422d2be83905149947d89327bb9c04173e38f74692.svg": ofs.readFileSync(path.join(__dirname, "./images/2fef7c3fc7e55034b2c382422d2be83905149947d89327bb9c04173e38f74692.svg"), "utf8"),
    "4ea5c508a6566e76240543f8feb06fd457777be39549c4016436afda65d2330e.svg": ofs.readFileSync(path.join(__dirname, "./images/4ea5c508a6566e76240543f8feb06fd457777be39549c4016436afda65d2330e.svg"), "utf8"),
};
...
describe("getJSON", () => {
    ...
    test("produces asset referenced icons when live-update", async () => {
        const json = await getJSON(mockState, { assetHost: "https://example.com/assets/icons" }, "live-update", assetAccessor);
        expect(json).toEqual({
            "main.discard": {
                default: {
